...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-href="https://cdnjs.cloudflare.com/ajascalable=no, viewport-fit=cover">
    <title>戸上アプリ Well-being</title>
    <link rel="stylesheet" x/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            /* ブランドカラー定義 */
...
<body>
    ...
    <main>
            ...
            <div id="content-exchange" class="hidden">
                <div class="card">
                    ...
                    <div class="exchange-item">
                        <div>
                            <div style="font-weight:bold;">戸上アプリ特製ステッカー（例）</div>
                    ...
                    <div class="exchange-item">
                        <div>
                            <div style="font-weight:bold;">千曲市オリジナルエコバッグ（例）</div>
                    ...
                    <div class="exchange-item">
                        <div>
                            <div style="font-weight:bold;">戸倉上山田温泉 入浴剤セット（例）</div>
        ...
        <div id="page-my-coupons" class="page">
             ...
             <h2>所持クーポン</h2>
             <div id="coupon-list-container" style="padding-bottom:20px;">
                 </div>
        </div>
        ...
        <div id="page-stamp-rally" class="page">
            ...
            <div class="map-view" id="stamp-map">
                </div>
            <div class="card">
        ...
        <div id="page-kairan" class="page">
            ...
            <div class="kairan-list" id="kairan-list-view">
                <div class="kairan-item urgent" style="background:white; padding:15px; border-radius:12px; margin-bottom:10px; border-left:4px solid var(--danger);" onclick="showModal('重要', '2/1よりゴミ収集日が変更になります。詳細は市ホームページをご確認ください。（例）', 'fa-triangle-exclamation')">
                    <div><div style="font-size:0.8rem;">2026.02.01</div><div style="font-weight:bold;">【重要】ゴミ収集日変更（例）</div></div>
                </div>
                <div class="kairan-item" style="background:white; padding:15px; border-radius:12px; border-left:4px solid var(--secondary);" onclick="showModal('公民館だより', '2月のイベントスケジュールが公開されました。（例）', 'fa-newspaper')">
                    <div><div style="font-size:0.8rem;">2026.01.20</div><div style="font-weight:bold;">公民館だより 2月号（例）</div></div>
                </div>
            </div>
        </div>
        <div id="page-random" class="page">
            ...
            <div id="omikuji-result" class="omikuji-result-card hidden">
                ...
                <button class="btn" style="margin-top:20px;" onclick="showToast('マップを起動しました（模擬）')">マップを開く</button>
            </div>
        </div>
        <div id="page-account" class="page">
            ...
            <div class="card">
                 ...
                 <div style="padding:15px 0; border-bottom:1px solid #eee; color:var(--danger); cursor:pointer;" onclick="resetData()">データのリセット（デバッグ用）</div>
            </div>
        </div>
        ...
        <div id="page-info" class="page">
            ...
            <div class="card" style="margin-bottom: 15px;">
                ...
                <p style="font-size: 0.9rem; line-height: 1.6;">
                    「戸上アプリ Well-being」は、千曲市の魅力を再発見し、地域とのつながりを深めながら、皆さまの日々の生活をより豊かに（ウェルビーイング向上）することを目的としています。<br>
                    楽しみながらポイントを貯め、地元のお店や施設でお得に使える循環を生み出します。
                </p>
            </div>

            <div class="card">
                <h3><i class="fa-solid fa-book-open" style="color:var(--secondary);"></i> 具体的な使い方</h3>
                <ul style="font-size: 0.9rem; line-height: 1.6; padding-left: 20px; color: var(--text-main); margin: 0;">
                    <li style="margin-bottom: 15px;"><strong>ポイントを貯める・使う：</strong><br>ホーム画面のポイント部分をタップすると、貯まったポイントでクーポンガチャを回したり、景品と交換したりできます。</li>
                    <li style="margin-bottom: 15px;"><strong>アミューズメント：</strong><br>千曲市に関する「クイズ」や、実際のスポットを巡る「スタンプラリー」で、遊びながらポイントを獲得できます。</li>
                    <li style="margin-bottom: 15px;"><strong>温泉診断：</strong><br>簡単な質問に答えるだけで、今のあなたの気分にぴったりな市内の温泉施設をご提案します。</li>
                    <li style="margin-bottom: 15px;"><strong>回覧板：</strong><br>地域の大切なお知らせやイベント情報を、スマホからいつでも確認できます。</li>
                    <li style="margin-bottom: 0;"><strong>ランダムお店（おみくじ）：</strong><br>1日1回運試し！おみくじの結果とともに、おすすめの地元スポットを発見できます。</li>
                </ul>
            </div>
        </div>
    ...
    <script>
        ...
        function updatePointsUI() {
            ...
            if(appData.coupons.length === 0) {
                container.innerHTML = '<div style="text-align:center; color:#999; padding:20px;">クーポンを持っていません。<br>ポイントを貯めてガチャを回そう！</div>';
            } else {
                appData.coupons.forEach(c => {
                    container.innerHTML += createCouponHTML(c);
                });
            }
        }
        ...
        function applySettingsUI() {
            ...
            if(appData.settings.fontSize === 'large') {
        ...
        function changeLanguage(val) {
            ...
            showToast(val === 'ja' ? '言語を日本語に設定しました' : 'Language set to English');
        }
        function updateLanguageUI(lang) {
            // data-lang-xx属性を持つ要素を一括更新
        ...
        function changeNotification(checked) {
            ...
            saveData();
            showToast(checked ? '通知をONにしました' : '通知をOFFにしました');
        }
        // --- 3. 名前変更機能 (New!) ---
        ...
        function openPage(pageId) {
            ...
            if(pageId === 'page-point-hub') {
                updatePointsUI();
                switchPointTab('gacha'); 
            }
            if(pageId === 'page-my-coupons') {
                updatePointsUI();
            }
        }
        // --- 5. ガチャ & ポイント交換 (Enhanced!) ---
        ...
        const couponPool = [
            { id: 1, name: "杏ソフト 50円引", desc: "千曲市観光会館ほか対象店舗で使用可能", icon: "fa-ice-cream" },
            { id: 2, name: "日帰り温泉 100円引", desc: "戸倉上山田温泉の対象施設で使用可能", icon: "fa-hot-tub-person" },
            { id: 3, name: "お土産 5%OFF", desc: "道の駅・指定店舗でのお買い物がお得に", icon: "fa-gift" },
            { id: 4, name: "【大当たり】入浴無料券", desc: "指定の温泉施設で1回入浴無料！", icon: "fa-star" }
        ];
        function playGacha() {
            ...
            // 3. アニメーション完了後、結果表示 (合計 1.8秒後)
            setTimeout(() => {
                // 抽選ロジック
                const rand = Math.random();
                let result;
                if(rand < 0.05) result = couponPool[3]; 
                else if(rand < 0.35) result = couponPool[1]; 
                else if(rand < 0.65) result = couponPool[0]; 
                else result = couponPool[2]; 
                ...
                const display = document.getElementById('new-coupon-display');
                display.innerHTML = `
                    <div style="font-size:4rem; color:var(--secondary); margin:10px;"><i class="fa-solid ${result.icon}"></i></div>
                    <h3 style="margin:5px 0;">${result.name}</h3>
                    <p style="color:#666;">${result.desc}</p>
                `;
        ...
        function closeGachaResult() {
            document.getElementById('gacha-result-overlay').classList.remove('active');
        }
        function createCouponHTML(coupon) {
            return `
            <div class="coupon-ticket">
                <div class="coupon-icon"><i class="fa-solid ${coupon.icon}"></i></div>
        ...
        function exchangeItem(itemName, cost) {
            if(confirm(`${itemName}を ${cost}pt で交換しますか？`)) {
                if(usePoints(cost)) {
                    showModal('交換完了', `${itemName}との交換手続きが完了しました。\n（窓口でこの画面を提示してください）`, 'fa-check');
                }
            }
        }
        // --- 6. スタンプラリー ---
        const stampSpots = [
            { id: 's1', name: '戸上神社', desc: '歴史ある神社。階段を登ると絶景が。', top: '20%', left: '30%', icon: 'fa-torii-gate' },
            { id: 's2', name: '千曲駅', desc: '旅の玄関口。', top: '50%', left: '60%', icon: 'fa-train' },
            { id: 's3', name: '万葉公園', desc: '歌碑が立ち並ぶ静かな公園。', top: '70%', left: '20%', icon: 'fa-tree' }
        ];
        let currentSpotId = null;
        function initStampRally() {
            openPage('page-stamp-rally');
            renderStampCard();
            renderMap();
        }
        function renderStampCard() {
            stampSpots.forEach(spot => {
                ...
                if(appData.stamps.includes(spot.id)) {
        ...
        function selectSpot(spot, isStamped) {
            ...
            document.getElementById('spot-desc').innerText = isStamped ? "スタンプ取得済みです。" : spot.desc + "\nボタンを押してチェックインしてください。";
            
            const btn = document.getElementById('stamp-btn');
            if(isStamped) {
                btn.disabled = true;
                btn.innerHTML = '<i class="fa-solid fa-check"></i> 取得済み';
                btn.className = 'btn secondary';
            } else {
                btn.disabled = false;
                btn.innerHTML = '<i class="fa-solid fa-location-dot"></i> チェックイン';
                btn.className = 'btn';
        ...
        function getStamp(id) {
            ...
            setTimeout(() => {
                if(!appData.stamps.includes(id)) {
                    appData.stamps.push(id);
                    addPoints(50);
                    showModal('スタンプGET!', 'スタンプカードに押印されました！\n50pt獲得！', 'fa-stamp');
                }
                renderStampCard(); 
                renderMap();       
                
                const spot = stampSpots.find(s => s.id === id);
                selectSpot(spot, true);
            }, 1500);
        }
        
        // --- 7. 温泉診断 ---
        // ※必ず3つの質問に答えるようにシナリオを修正しました
        const onsenScenario = [
            // Q1: 最初の質問
            { q: "今の気分は？", options: [
                { txt: "とにかく癒やされたい", next: 1 },
                { txt: "リフレッシュ・遊びたい", next: 1 } 
            ]},
            // Q2: 2つ目の質問
            { q: "お湯の好みは？", options: [
                { txt: "硫黄の香りがする温泉", next: 2 }, 
                { txt: "肌に優しい単純泉", next: 3 } 
            ]},
            // Q3: 3つ目の質問（硫黄泉ルート）
            { q: "雰囲気の希望は？", options: [
                { txt: "レトロな銭湯スタイル", result: "A" }, 
                { txt: "静かな環境でゆっくり", result: "C" } 
            ]},
            // Q3: 3つ目の質問（単純泉ルート）
            { q: "施設の設備は？", options: [
                { txt: "サウナも楽しみたい", result: "B" }, 
                { txt: "絶景・露天風呂重視", result: "D" } 
            ]}
        ];
        ...
        const onsenResults = {
            ...
            "C": { name: "亀の湯", desc: "タイル画が美しい昔ながらの公衆浴場。" },
            "D": { name: "白鳥園", desc: "お洒落なカフェも併設。絶景露天風呂。" }
        };
        
        function startOnsenDiagnosis() {
            openPage('page-onsen');
            document.getElementById('onsen-chat-area').innerHTML = '';
            document.getElementById('onsen-options').innerHTML = '';
            addBotMsg("こんにちは！あなたにぴったりの温泉を探しますね。");
            setTimeout(() => showOnsenQuestion(0), 600);
        }
        function addBotMsg(text) {
            const d = document.createElement('div');
            d.className = 'chat-msg fade-in';
            d.innerText = text;
        ...
        function showOnsenQuestion(idx) {
            ...
            qData.options.forEach(opt => {
                ...
                btn.onclick = () => {
                    ...
                    optArea.innerHTML = '';
                    setTimeout(() => {
                        if(opt.result) showOnsenFinalResult(opt.result);
                        else showOnsenQuestion(opt.next);
                    }, 600);
                };
        ...
        function showOnsenFinalResult(type) {
            const res = onsenResults[type];
            addBotMsg("診断結果が出ました！おすすめはこちらです。");
            setTimeout(() => {
                const resultHtml = `
                    <div class="card fade-in" style="margin-top:10px;">
                        <h3 style="color:var(--primary);">${res.name}</h3>
                        <p style="font-size:0.9rem;">${res.desc}</p>
                        <button class="btn" onclick="openPage('page-home')">トップへ戻る</button>
                    </div>
                `;
                document.getElementById('onsen-chat-area').insertAdjacentHTML('beforeend', resultHtml);
                window.scrollTo(0, document.body.scrollHeight);
            }, 1000);
        }
        ...
        // --- 8. クイズ ---
        const quizData = [
            { q: "千曲市の名産品として最も有名な果物は？", a: ["あんず", "りんご", "ぶどう", "もも"], correct: 0 },
            { q: "「姨捨の棚田」は国の何に選定されている？", a: ["重要文化的景観", "世界遺産", "特別天然記念物", "国宝"], correct: 0 },
            { q: "戸倉上山田温泉の泉質の特徴として正しいのは？", a: ["美肌の湯(アルカリ性)", "強酸性", "炭酸泉", "泥湯"], correct: 0 }
        ];
        
        let currentQuizIndex = 0;
        let quizScore = 0;
        let isAnswering = false; // ※追加: 連打防止用のフラグ
        
        function initQuiz() {
            openPage('page-quiz-game');
            currentQuizIndex = 0;
            quizScore = 0;
            isAnswering = false; // 初期化時にフラグを下ろす
        ...
        function checkAnswer(selectedIndex) {
            if (isAnswering) return; // 回答中（アニメーション中）なら何もしない
            isAnswering = true;      // フラグを立てて以降のタップを無効化
            ...
            setTimeout(() => {
                ...
                if (currentQuizIndex < quizData.length) {
                    showQuestion();
                    isAnswering = false; // 次の問題が表示されたらタップできるようにフラグを下ろす
                } else {
                    showQuizResult();
                    isAnswering = false; // 終了時も念のためリセット
                }
            }, 800);
        }
        ...
        function playOmikuji() {
            ...
            const hint = document.getElementById('omikuji-hint');
            
            box.classList.add('shaking');
            hint.innerText = "念を込めて...";
        ...
        function createSakura() {
            ...
            for(let i=0; i<30; i++) {
                ...
                el.style.backgroundColor = Math.random() > 0.5 ? '#FFC0CB' : '#FFB7C5';
                container.appendChild(el);
            }
        }
        // 初期化
